...
class AssistSatelliteEntity(entity.Entity):
    ...
    async def async_internal_announce(
        ...
        media_id = await self._resolve_media_id(message, media_id)
    ...
    async def async_internal_start_conversation(
        ...
        start_media_id = await self._resolve_media_id(start_message, start_media_id)
        ...
        try:
            await self.async_start_conversation(start_message, start_media_id)
        finally:
            self._is_announcing = False
    ...
    async def _resolve_media_id(self, message: str, media_id: str | None) -> str:
